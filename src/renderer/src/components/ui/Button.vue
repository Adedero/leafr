...
import type { UIColor, UISize, UIVariant } from "@renderer/types/ui.type";
...
const sizeClasses: Record<UISize, string> = {
  sm:
    slots.default || label ? "h-7 px-2.5 text-xs gap-1.5" : "h-7 aspect-square",
  md: slots.default || label ? "h-9 px-3.5 text-sm gap-2" : "h-9 aspect-square",
  lg:
    slots.default || label ? "h-11 px-4 text-base gap-2" : "h-11 aspect-square",
  xl:
    slots.default || label ? "h-13 px-5 text-lg gap-2.5" : "h-13 aspect-square"
};
...
const colorVariantClasses: Partial<Record<ColorVariantKey, string>> = {
  ...
  "primary-outline":
    "border-accent text-accent hover:bg-accent/10 active:bg-accent/20",
  "primary-soft":
    "bg-accent/15 text-accent hover:bg-accent/25 active:bg-accent/35",
  "primary-subtle":
    "border-accent bg-accent/20 text-accent hover:bg-accent/10 active:bg-accent/20",
  ...
  "secondary-filled":
    "bg-secondary text-background hover:bg-secondary/85 active:bg-secondary/70",
  "secondary-outline":
  ...
  "warning-filled":
    "bg-warning text-background hover:bg-warning/85 active:bg-warning/70",
  "warning-outline":
    "border-warning text-warning hover:bg-warning/10 active:bg-warning/20",
  "warning-soft":
    "bg-warning/15 text-warning hover:bg-warning/25 active:bg-warning/35",
  "warning-subtle":
  ...
  "error-filled":
    "bg-error text-background hover:bg-error/85 active:bg-error/70",
  "error-outline":
    "border-error text-error hover:bg-error/10 active:bg-error/20",
  "error-soft": "bg-error/15 text-error hover:bg-error/25 active:bg-error/35",
  "error-subtle":
    "border-error bg-error/20 text-error hover:bg-error/10 active:bg-error/20",
  ...
  "neutral-filled":
    "bg-text text-background hover:bg-text/85 active:bg-text/70",
  "neutral-outline":
    "border-border text-text hover:bg-text/10 active:bg-text/15",
  "neutral-soft": "bg-text/10 text-text hover:bg-text/15 active:bg-text/20",
  "neutral-subtle":
    "border-border bg-text/20 text-text hover:bg-text/10 active:bg-text/15",
  "neutral-ghost":
    "text-muted hover:text-text hover:bg-text/10 active:bg-text/15",
...
<template>
  ...
  >
    ...
    <span
      v-if="isLoading"
      :class="twMerge('shrink-0', iconSizeClasses[size], ui?.icon)"
    >
    ...
    <span
      ...
      :class="twMerge(iconSizeClasses[size], ui?.icon)"
    >
      <slot name="icon">
    ...
    <span
      ...
      :class="twMerge('leading-none', ui?.label)"
    >
      <slot>
        <slot>{{ label }}</slot>
      </slot>
